...
window.BOARD_CONFIG = {
  ...
  staffPassword: "Recruit26", // only used when supabase auth is off
  // Individual logins + shared cloud board. Paste your project's URL and anon
  // key (Project Settings -> API); until then the app runs in device-only mode.
  supabase: {
    url: "PASTE_YOUR_PROJECT_URL_HERE",
    anonKey: "PASTE_YOUR_ANON_KEY_HERE",
    auth: true,
    emailDomain: "kstate.board",
  },
};
